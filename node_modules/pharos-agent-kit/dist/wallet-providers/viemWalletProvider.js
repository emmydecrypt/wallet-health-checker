...
const pharosWalletProvider_1 = require("./pharosWalletProvider");
const network_1 = require("../network/network");
const network_2 = require("../network/network");
const utils_1 = require("../utils");
/**
 * A wallet provider that uses the Viem library.
 */
class ViemWalletProvider extends pharosWalletProvider_1.PharosWalletProvider {
    /**
    ...
    constructor(walletClient, gasConfig) {
        ...
        __classPrivateFieldSet(this, _ViemWalletProvider_publicClient, (0, viem_1.createPublicClient)({
            chain: walletClient.chain || network_2.pharosDevnet, // Default to Pharos if no chain specified
     ...
     */
    getNetwork() {
        const chain = __classPrivateFieldGet(this, _ViemWalletProvider_walletClient, "f").chain || network_2.pharosDevnet;
        return {
            protocolFamily: "pharos",
            chainId: String(chain.id),
            networkId: network_1.CHAIN_ID_TO_NETWORK_ID[chain.id],
        };
    }
    /**
    ...
    async writeContract(params) {
        return __classPrivateFieldGet(this, _ViemWalletProvider_walletClient, "f").writeContract(params);
    }
    /**
...
//# sourceMappingURL=viemWalletProvider.js.map