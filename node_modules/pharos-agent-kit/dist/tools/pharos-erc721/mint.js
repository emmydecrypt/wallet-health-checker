...
exports.erc721Mint = erc721Mint;
const viem_1 = require("viem");
const isContract_1 = require("../../utils/isContract");
const network_1 = require("../../network");
const erc721Abi = (0, viem_1.parseAbi)([
 ...
 */
async function erc721Mint(agent, recipient, tokenAddress, tokenId) {
    ...
    try {
        ...
        try {
            const isValidContract = await (0, isContract_1.isContract)(agent, tokenAddress);
            if (!isValidContract) {
