...
exports.createPharosTools = createPharosTools;
const ai_1 = require("ai");
const actionExecutor_1 = require("../utils/actionExecutor");
const actions_1 = require("../actions");
function createPharosTools(PharosAgentKit) {
    const tools = {};
    ...
    for (const key of actionKeys) {
      ...
      `.slice(0, 1023),
            ...
            execute: async (params) => await (0, actionExecutor_1.executeAction)(action, PharosAgentKit, params),
        });
    }
    return tools;
}
