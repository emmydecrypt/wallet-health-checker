...
exports.elfaSmartTwitterAccountStats = exports.elfaTrendingTokensAction = exports.elfaSearchMentionsByKeywordsAction = exports.elfaGetTopMentionsByTickerAction = exports.elfaGetSmartMentionsAction = exports.elfaApiKeyStatusAction = exports.elfaPingAction = void 0;
const zod_1 = require("zod");
exports.elfaPingAction = {
        ...
        [
            {
                ...
                explanation: "If the API is healthy, the ping endpoint returns a pong message.",
            },
        ],
    ],
...
exports.elfaApiKeyStatusAction = {
        ...
        [
            {
                ...
                explanation: "Returns details such as remaining requests and API key status.",
            },
        ],
    ],
    schema: zod_1.z.object({}),
...
exports.elfaGetSmartMentionsAction = {
                        ...
                        data: [
                            {
                                ...
                                account: {
                                    ...
                                    data: {
                                        ...
                                        profileImageUrl: "https://pbs.twimg.com/profile_images/1648453285890916355/rqqWLR8O_normal.jpg",
                                        profileBannerUrl: "https://pbs.twimg.com/profile_banners/39349894/1516709628",
                                    },
                            ...
                            },
                            {
                                id: "611185071",
                                type: "post",
                                content: "In my opinion, its a great time to add $ETH. You can thank me later.",
...
exports.elfaGetTopMentionsByTickerAction = {
    ...
    schema: zod_1.z.object({
        ...
        pageSize: zod_1.z.number().optional().describe("Number of mentions per page"),
        includeAccountDetails: zod_1.z
            .boolean()
            .optional()
    ...
    handler: async (agent, input) => {
        ...
        const data = await agent.getTopMentionsByTicker(ticker, timeWindow, page, pageSize, includeAccountDetails);
        return {
            status: "success",
            data,
...
exports.elfaSearchMentionsByKeywordsAction = {
        ...
        [
            {
                ...
                output: {
                    ...
                    data: {
                        ...
                        metadata: {
                            total: 1875,
                            cursor: "",
                        },
                    },
                },
                explanation: "Tweets mentioning the keywords within the specified range are returned.",
            },
        ],
    ],
    schema: zod_1.z.object({
        ...
        from: zod_1.z.number().describe("Start date as unix timestamp"),
        to: zod_1.z.number().describe("End date as unix timestamp"),
        limit: zod_1.z
            .number()
            .optional()
    ...
    handler: async (agent, input) => {
        ...
        const data = await agent.searchMentionsByKeywords(keywords, from, to, limit);
        return {
            status: "success",
            data,
...
exports.elfaTrendingTokensAction = {
        ...
        [
            {
                ...
                explanation: "Trending tokens are returned based on the latest mentions.",
            },
        ],
    ],
    schema: zod_1.z.object({}),
...
exports.elfaSmartTwitterAccountStats = {
        ...
        [
            {
                ...
                explanation: "Smart stats for the provided Twitter username are returned.",
            },
        ],
    ],
    schema: zod_1.z.object({
...
//# sourceMappingURL=elfa_ai_actions.js.map